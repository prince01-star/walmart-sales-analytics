...
USE Walmart;
GRANT ALL PRIVILEGES ON Walmart.* TO 'root'@'localhost';
FLUSH PRIVILEGES;
...
FROM (
    SELECT 
        ...
        -- Changed 'rank' to 'day_rank' because 'rank' is a reserved keyword
...
WITH cte AS (
    SELECT 
        ...
        -- Renamed 'rank' to 'payment_rank' to avoid reserved word errors
...
SELECT 
    ...
    total_trans -- Optional: Included so you can see the actual volume
FROM cte
